...
public class BasicDataTypes {
    public static void main(String[] args) {
        ...
        /**
         * "boolean" s a data type that represents a logical value. It is used to
         * indicate whether a condition
         * is true or false. In Java, the "boolean" data type is a primitive type that
         * can have one
        ...
        /**
         * "byte" is a data type used to represent integer values that require a smaller
         * range than what can be
         * accommodated by the "int" data type. In Java, the "byte" data type is a 8-bit
         * signed integer.
         *
         * The range of values that can be represented by a "byte" variable in Java is
         * approximately
         * from -128 to 127. This range is narrower compared to the "int" data type,
         * which allows
        ...
        /**
         * "short" is a data type used to represent integer values that require a
         * smaller range than what can be
         * accommodated by the "int" data type. In Java, the "short" data type is a
         * 16-bit signed integer.
         *
         * The range of values that can be represented by a "short" variable in Java is
         * approximately
         * from -32,768 to 32,767. This range is narrower compared to the "int" data
         * type, which allows
        ...
        /**
         * The "int" data type is commonly used for representing and performing
         * calculations with whole numbers.
         * The range of values that can be represented by an "int" variable in Java is
         * approximately from
         * -2,147,483,648 to 2,147,483,647. This range is determined by the size of the
         * data type,
        ...
        /**
         * The ""long" is a data type used to represent integer values that require a
         * larger range than what can be
         * accommodated by the "int" data type. In Java, the "long" data type is a
         * 64-bit signed integer.
         *
         * The range of values that can be represented by a "long" variable in Java is
         * approximately
         * from -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807. This expanded
         * range allows "long" to store
        ...
        /**
         * The "float" data type is commonly used when you need to represent numbers
         * with a fractional part
         * in Java is a 32-bit value that conforms to the IEEE 754 floating-point
         * standard
         */
        // For example
        ...
        /**
         * The "double" data type is commonly used when you need to represent numbers
         * with a fractional part
         * in Java is a 64-bit value that conforms to the IEEE 754 floating-point
         * standard
         */
        // For example
         ...
         * In Java, the "String" class is provided as a built-in class to handle textual
         * data
         */
        // For example
